...
Checkout.prototype = {
    initialize: function(accordion, urls){
        ...
        this.steps = ['login', 'billing', 'shipping_payment'];
...
Billing.prototype = {
    ...
    nextStep: function(transport){
        ...
        $('opc-shipping_payment').setAttribute('class','section open');
        $('opc-billing').setAttribute('class','section completed');
        jQuery('.checkout-steps-title .step-3').addClass('active');
        $('checkout-step-billing').hide();
        $('checkout-step-shipping_payment').show();
        checkout.setStepResponse(response);
        shippingPayment.initWhatIsCvvListeners();
...
var shippingPaymentMethod = Class.create();
shippingPaymentMethod.prototype = {
    beforeInitFunc:$H({}),
    afterInitFunc:$H({}),
    ...
    save: function(){
        ...
        if (this.validate() && validator.validate()) {
            checkout.setLoadWaiting('shipping_payment');
    ...
    nextStep: function(transport){
        ...
        checkout.setStepResponse(response);
        $('shipping_payment-progress-opcheckout').show();
        $('opc-shipping_payment').setAttribute('class','section completed');
        $('opc-review').setAttribute('class','section open');
        //checkout.setPayment();
    },
...
Review.prototype = {
    ...
    save: function(){
        if (checkout.loadWaiting!=false) return;
        checkout.setLoadWaiting('shipping_payment');
        var params = Form.serialize(shippingPayment.form);
